...
public class BoidGenome extends Genome {
    ...
    protected Map<String, Object> createGenes() {
        ...
        result.put(Locomotion.PARAMETER_PREFIX + "separation", RandomProvider.nextInt(MAX_SEPARATION));
        result.put(Locomotion.PARAMETER_PREFIX + "alignment", RandomProvider.nextInt(MAX_ALIGNMENT));
        result.put(Locomotion.PARAMETER_PREFIX + "cohesion", RandomProvider.nextInt(MAX_COHESION));
