...
import com.github.thehilikus.alife.agent.moods.Existing2;
import com.github.thehilikus.alife.agent.moods.Flocking;
import com.github.thehilikus.alife.agent.moods.api.Mood;
import com.github.thehilikus.alife.agent.motion.Legs;
...
public class BoidFactory extends LivingAgentFactory {
    private static final Logger LOG = LoggerFactory.getLogger(BoidFactory.class);
    ...
    protected LivingAgent createAgent() {
        ...
        Boid result = createAgentFromGenome(genome, getWorld().getRandomPosition());
    ...
    private Boid createAgentFromGenome(Genome genome, Position position) {
        ...
        dependencies.addComponent(Locomotion.class, new Wings(getWorld().getWidth(), getWorld().getHeight(), id, position, genome));
        ...
        Boid result = new Boid(id, dependencies, startingMood, vitalsController);
