...
public class BoidView implements AgentView {

    private static final int FLOCKING_Z_ORDER = 15;
    private static final double OLD_AGE_PROPORTION = 0.20;
    /**
     * Mapping of moods to colours
     */
    private static final Map<String, Color> graphicalMoodColours = Map.of(
            "Eating", Color.GREEN,
            "Existing2", Color.GRAY,
            "Flocking", Color.YELLOW,
//            "Hunting", Color.BLUE,
//            "InHeat", Color.PINK,
...
//            "Scouting", Color.CYAN,
    ...
    public AgentKeyframe createAgentFrame(Agent agent) {
        ...
        int zOrder = 7;
        if (moodName.equals("Flocking")) {
            zOrder = FLOCKING_Z_ORDER;
        }
        AgentKeyframe result = new AgentKeyframe(agent.getId(), zOrder, details);
...
//            }
        ...
        Shape agentShape = createBoidShape(newKeyframe);
        g2d.fill(agentShape);
    ...
    private Shape createBoidShape(AgentKeyframe frame) {
...
//        size *= 5; //TODO remove
    ...
    public void drawTweenFrame(Graphics2D g2d, AgentKeyframe lastKeyframe, AgentKeyframe newKeyframe, double percentToKeyframe) {
        ...
        g2d.setStroke(stroke);
        Shape agentShape = createBoidShape(tweenFrame);
        g2d.fill(agentShape);
